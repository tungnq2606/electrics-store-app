...
public class UpdateProductDialog extends DialogFragment {
    ...
    private String url_download = null, editProductName, editProductImage,editProductCategory;
    private Float editProductPrice;
    private Dialog dialog;
    private FirebaseStorage storage;
    private TextView imageError,title,buttonTitle;
    private int id;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            editProductCategory = getArguments().getString("category_name", "");
            editProductImage = getArguments().getString("image_url", "");
            editProductPrice = getArguments().getFloat("product_price", 0);
            editProductName = getArguments().getString("product_name", "");
        }
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        buttonTitle = view.findViewById(R.id.productBtnTitle);
        ...
        title = view.findViewById(R.id.product_form_title);
        title.setText("Update Product");
        buttonTitle.setText("Update");
//
        imageError.setVisibility(View.GONE);
        imageError.setVisibility(View.GONE);
        edName.setText(editProductName);
        edPrice.setText(String.valueOf(editProductPrice));
        atCategory.setText(editProductCategory);
        Glide.with(getContext()).load(editProductImage).into(img);
//
...
//
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    UpdateProduct(categoryName, productName, price);
                }
        });
    ...
    private void UpdateProduct(String category_name, String product_name, float price) {
        ...
        if (imageUri != null) {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            service.updateProduct(new Products(product_name, url_download, category_name, price, id)).enqueue(updateProductCallback);
                        }
            ...
            service.updateProduct(new Products(product_name, editProductImage, category_name, price, id)).enqueue(updateProductCallback);
        }
    }
    ...
    Callback<String> updateProductCallback = new Callback<String>() {
        @Override
